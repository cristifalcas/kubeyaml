...
func run(in io.Reader, out io.Writer, args ...string) error {
	...
	opts.versions = validate.String("versions", "1.31,1.30,1.29,1.28,1.27,1.26,1.25,1.24,1.23,1.22,1.21,1.20", "comma separated list of kubernetes versions to validate against")
